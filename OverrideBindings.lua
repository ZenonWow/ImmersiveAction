...
function WorldClickHandler.OnMouseDown(frame, button)
	...
	-- if command=='MOVEFORWARD' then  IA:ProcessCommand('MoveForwardTurns', true)  end
	if command=='MOVEFORWARD' then  IA:ProcessCommand('MoveAndSteer', true)  end
...
function WorldClickHandler.OnMouseUp(frame, button)
	...
	-- if command=='MOVEFORWARD' then  IA:ProcessCommand('MoveForwardTurns', false)  end
	-- Trigger enableAfterMoveAndSteer.
	if command=='MOVEFORWARD' then  IA:ProcessCommand('MoveAndSteer', false)  end
